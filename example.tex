...
\todo[inline]{Mas isso eh trabalho futuro ou ja foi feito?}
\end{abstract}
...
\todo[inline]{Jean diz: A introducao esta boa. Tem alguns detalhes que vou verificar quando acabar as outras secoes}
	...
	Later, we show hour k-means clustering can be used to identify regions and similarities \todo[inline]{between what?}.
